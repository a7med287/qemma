            ...
            child: Transform.translate(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  _InfoCard(isDark: isDark, title: '📖 عن الكتاب', children: [
                  ...
                  _InfoCard(isDark: isDark, title: '📋 معلومات الكتاب', children: [
                    _InfoRow(icon: Icons.folder_rounded, label: 'المادة', value: b['subject'] ?? 'غير محدد', isDark: isDark),
                    const Divider(),
                    _InfoRow(icon: Icons.update_rounded, label: 'آخر تحديث', value: b['updatedAt']?.toString() ?? 'غير محدد', isDark: isDark),
                    const Divider(),
                    _InfoRow(icon: Icons.school_rounded, label: 'المستوى', value: b['grade'] ?? 'عام', isDark: isDark),
                  ]),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => TeacherProfilePage(teacherId: '${b['teacherId']}'))),
                    child: Container(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, fontFamily: 'Cairo', color: isDark ? const Color(0xFFF1F5F9) : const Color(0xFF1E293B))),
          const SizedBox(height: 16),
          ...children,
        ],
      ),
