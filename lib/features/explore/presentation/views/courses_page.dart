                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            StatItem(icon: Icons.play_circle_outline_rounded, value: '${course.lessonsCount}', label: 'درس', isDark: isDark),
                            const Spacer(),
                            StatItem(icon: Icons.access_time_rounded, value: course.duration, label: 'مدة', isDark: isDark),
                          ],
                        ),
                      ],
                    ),
