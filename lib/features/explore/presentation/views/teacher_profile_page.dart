                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              runSpacing: 4,
                              children: [
                                StatChip(icon: Icons.star_rounded, iconColor: const Color(0xFFFBBF24), text: '${t.rating}'),
                                StatChip(icon: Icons.people_rounded, text: '${t.studentsCount} طالب'),
                                StatChip(icon: Icons.school_rounded, text: '${t.coursesCount} كورسات'),
                                StatChip(icon: Icons.menu_book_rounded, text: '${t.booksCount} كتب'),
                              ],
                            ),
                          ],
                        ),
